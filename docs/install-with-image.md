...
get a permission error, you will need to message [[User:TimClifford|Tim]] or
...
gpg --verify hades-rev1.qcow2.asc hades-rev1.qcow2 # Verify that Tim signed the image
